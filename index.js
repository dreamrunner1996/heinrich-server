...
app.get('/studyHtml', (req, res) => {
    res.setHeader('Content-Type','text/plain;charset=utf-8')
    res.setHeader('Access-Control-Allow-Origin', '*')
    res.setHeader('Access-Control-Allow-Methods', 'POST, GET, OPTIONS, DELETE')
    let data = fs.readFileSync('./study/html.json', "utf-8")
    res.send(data)
})
app.get('/studyCss', (req, res) => {
    res.setHeader('Content-Type','text/plain;charset=utf-8')
    res.setHeader('Access-Control-Allow-Origin', '*')
    res.setHeader('Access-Control-Allow-Methods', 'POST, GET, OPTIONS, DELETE')
    let data = fs.readFileSync('./study/css.json', "utf-8")
    res.send(data)
})
app.get('/studyVue', (req, res) => {
    res.setHeader('Content-Type','text/plain;charset=utf-8')
    res.setHeader('Access-Control-Allow-Origin', '*')
    res.setHeader('Access-Control-Allow-Methods', 'POST, GET, OPTIONS, DELETE')
    let data = fs.readFileSync('./study/vue.json', "utf-8")
    res.send(data)
})
app.get('/studyElectron', (req, res) => {
    res.setHeader('Content-Type','text/plain;charset=utf-8')
    res.setHeader('Access-Control-Allow-Origin', '*')
    res.setHeader('Access-Control-Allow-Methods', 'POST, GET, OPTIONS, DELETE')
    let data = fs.readFileSync('./study/electron.json', "utf-8")
    res.send(data)
})
app.get('/studyNodeJS', (req, res) => {
    res.setHeader('Content-Type','text/plain;charset=utf-8')
    res.setHeader('Access-Control-Allow-Origin', '*')
    res.setHeader('Access-Control-Allow-Methods', 'POST, GET, OPTIONS, DELETE')
